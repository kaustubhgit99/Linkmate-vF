    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <div className="pt-[64px] max-w-7xl mx-auto px-5 py-8">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="font-display text-[#141414]" style={{ fontSize: 'clamp(1.6rem,3vw,2.2rem)' }}>Saved Rooms</h1>
            <p className="text-[13px] text-[#5A5A58] mt-0.5">{rooms.length} saved</p>
          </div>
        </motion.div>

        {!user ? (
          <div className="text-center py-24">
            <Heart className="w-12 h-12 mx-auto mb-4 text-[#E4E4E2]" />
            <h3 className="font-display text-[#141414] text-[1.3rem] mb-2">Sign in to see saved rooms</h3>
            <p className="text-[13px] text-[#5A5A58] mb-6">Tap the heart on any room to save it here.</p>
          ...
          <div className="text-center py-24">
            <Heart className="w-12 h-12 mx-auto mb-4 text-[#E4E4E2]" />
            <h3 className="font-display text-[#141414] text-[1.3rem] mb-2">No saved rooms yet</h3>
            <p className="text-[13px] text-[#5A5A58] mb-6">Tap the heart on any room to save it here.</p>
